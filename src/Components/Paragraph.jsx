...
const Character = ({ children, range, progress }) => {
  ...
  return (
    <span className={styles.characterContainer}>
      <span
        className={`text-4xl sm:text-3xl md:text-5xl lg:text-8xl xl:text-8xl 2xl:text-8xl ${styles.shadow} px-1 md:px-2 lg:px-3`}
      >
        {children}
      </span>
      <motion.span
        style={{ opacity, color }}
        className={`text-4xl sm:text-3xl md:text-5xl lg:text-8xl xl:text-8xl 2xl:text-8xl px-1 md:px-2 lg:px-3`}
      >
        {children}
      </motion.span>
    </span>
